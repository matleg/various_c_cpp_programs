...
void Person::WhoAmIV2()
{
    cout << " I am a person !!!!" << name_ << endl;
}
...
public:
    ...
    void WhoAmI()
    {
        cout << " \nI am an employee :" << id << endl
             << endl;
    }

    void WhoAmIV2() override
    {

        cout << "overrided , I am an employee " << id << endl;
    }
};
